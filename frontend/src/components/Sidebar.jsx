                    ...
                    <ul className="">
                        {filteredUsers.map((user) => (
                            <li
                                ...
                                key={user._id}
                                className={`flex bg-gray-100 items-center gap-3 p-2 backdrop-brightness-150 rounded-xl transition-all duration-200 ease-in-out hover:shadow-md hover:bg-indigo-400 cursor-pointer ${
                                    selectedUser?._id === user._id ? "bg-gray-400 ring-1 ring-base-300 text-white" : ""
                                }mb-2`}
                            >
                                <img
